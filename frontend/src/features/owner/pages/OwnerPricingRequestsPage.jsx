...
export default function OwnerPricingRequestsPage() {
  ...
  return (
    <section style={{ display: "grid", gap: 14 }}>
      <div>
        <h1 style={{ margin: 0 }}>✅ Duyệt Pricing Requests</h1>
        <p style={{ margin: "4px 0 0", color: "#64748b", fontSize: 13 }}>Owner là người quyết định chính — có thể uỷ quyền cho trợ lý</p>
      </div>
