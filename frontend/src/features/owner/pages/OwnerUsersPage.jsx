  ...
  return (
    <section style={{ display: "grid", gap: 16 }}>
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 12, opacity: 0.7, marginBottom: 4 }}>Quản lý hệ thống</div>
          <div style={{ fontWeight: 800, fontSize: 20 }}>Users & Permissions</div>
          <div style={{ fontSize: 13, opacity: 0.75, marginTop: 2 }}>{rows.length} tài khoản trong hệ thống</div>
        </div>
      </div>
