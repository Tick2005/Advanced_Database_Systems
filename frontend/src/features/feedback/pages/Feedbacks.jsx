...
export default function Feedbacks() {
  ...
  if (feedbacksQuery.error) return <ErrorState message={feedbacksQuery.error.message || "Khong the tai feedbacks"} onRetry={feedbacksQuery.refetch} />;
  if (bookingsQuery.error) return <ErrorState message={bookingsQuery.error.message || "Khong the tai booking history"} onRetry={bookingsQuery.refetch} />;
