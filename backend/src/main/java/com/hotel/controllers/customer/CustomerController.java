...
public class CustomerController {
	...
	public ApiResponse<FeedbackResponse> createFeedback(@Valid @RequestBody FeedbackCreateRequest payload) {
		return ApiResponse.ok("Feedback submitted", feedbackService.create(payload, requireCurrentUserId()));
	}
	...
	@GetMapping("/settings")
	public ApiResponse<CustomerSettingsResponse> getSettings() {
		return ApiResponse.ok("Customer settings", customerSettingsService.getByUserId(requireCurrentUserId()));
	}

	@PutMapping("/settings")
	public ApiResponse<CustomerSettingsResponse> updateSettings(
		@Valid @RequestBody CustomerSettingsUpdateRequest payload
	) {
