    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              {isAuthenticated && role !== "CUSTOMER" && (
                <>
                  ...
                  <button type="button" style={{ ...PILL, border: "1px solid #fecaca", color: "#b91c1c", background: "#fff5f5" }} onClick={handleLogout}>
                    🚪 Đăng xuất
                  </button>
                </>
              )}
      ...
      {!userLocation && (
        <div className="container" style={{ paddingTop: 12 }}>
          <div className="surface-panel" style={{ padding: "14px 16px", display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
            <div style={{ display: "grid", gap: 2 }}>
              <strong style={{ color: "#0d2238", fontSize: 14 }}>Bật vị trí để nhận gợi ý gần bạn</strong>
              <span style={{ color: "#64748b", fontSize: 13 }}>Cho phép LuxStay truy cập vị trí để ưu tiên chi nhánh và phòng phù hợp hơn.</span>
              {locationPromptError && <span style={{ color: "#b91c1c", fontSize: 12 }}>{locationPromptError}</span>}
            </div>
            <button 
              type="button" 
            ...
            >
              {locationLoading ? "⏳ Đang xin cấp phép..." : "📍 Cho phép vị trí"}
            </button>
          </div>
        </div>
      )}
