  ...
  return (
    <section style={{ display: "grid", gap: 16 }}>
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 12, opacity: 0.7, marginBottom: 4 }}>Quản lý booking</div>
          <div style={{ fontWeight: 800, fontSize: 20 }}>Booking Chi Nhánh</div>
          <div style={{ fontSize: 13, opacity: 0.75, marginTop: 2 }}>Tất cả đặt phòng được quản lý từ đây</div>
        </div>
      </div>
