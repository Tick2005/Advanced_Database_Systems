              ...
              {showCameraModal && (
                <div className="modal-overlay" onClick={closeCameraModal} style={{ zIndex: 400 }}>
                  <div className="card modal-card" style={{ maxWidth: 640 }} onClick={(e) => e.stopPropagation()}>
                    ...
                    <div style={{ marginTop: 12, display: 'flex', justifyContent: 'center', minHeight: 300 }}>
                      <video ref={videoRef} style={{ width: '100%', maxHeight: 480, background: '#000', borderRadius: 12, objectFit: 'cover' }} autoPlay playsInline muted />
                    </div>
                    <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 12 }}>
                      ...
                      <button type="button" onClick={captureFromCamera} style={{ padding: '8px 12px', borderRadius: 12, border: 'none', background: 'linear-gradient(135deg,#c9a84c,#9a7d24)', color: '#fff', fontWeight: 700 }}>Chụp & Lưu</button>
                    </div>
                  </div>
                </div>
              )}
