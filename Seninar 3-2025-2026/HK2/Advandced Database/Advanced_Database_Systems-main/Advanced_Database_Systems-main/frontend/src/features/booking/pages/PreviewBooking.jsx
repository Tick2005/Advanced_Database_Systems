// commit: fix(preview-booking): sửa encoding tiếng Việt
    ...
    return (
      <section className="container" style={{ padding: "28px 24px" }}>
        ...
        <div style={{ color: "#b91c1c", marginBottom: 10 }}>
          {(roomsQuery.error || branchesQuery.error)?.message || "Không thể tải dữ liệu đặt phòng"}
        </div>
  ...
  return (
    <section className="container" style={{ padding: "28px 24px" }}>
      ...
      <div className="card" style={{ padding: 18, display: "grid", gap: 12 }}>
        ...
        {createBookingMutation.error && <div style={{ color: "#b91c1c" }}>{createBookingMutation.error.message || "Không thể tạo booking"}</div>}
