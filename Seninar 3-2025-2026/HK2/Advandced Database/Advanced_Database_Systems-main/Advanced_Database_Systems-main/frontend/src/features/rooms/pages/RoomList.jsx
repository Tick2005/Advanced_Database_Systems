// commit: fix(room-list): sửa encoding tiếng Việt trong error message
...
export default function RoomList({ customer = false }) {
  ...
  if (roomsQuery.error) {
    return <ErrorState message={roomsQuery.error.message || "Không thể tải danh sách phòng"} onRetry={roomsQuery.refetch} />;
  }
