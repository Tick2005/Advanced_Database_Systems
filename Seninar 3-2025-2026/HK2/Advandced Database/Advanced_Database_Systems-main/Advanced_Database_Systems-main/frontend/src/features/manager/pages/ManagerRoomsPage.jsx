    ...
    <section style={{ display: "grid", gap: 16 }}>
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontWeight: 800, fontSize: 20 }}>Quản lý Phòng</div>
          {branch && <div style={{ fontSize: 13, opacity: 0.75, marginTop: 2 }}>{branch.name} — {branch.city}</div>}
        </div>
      </div>
          ...
          <tbody>
            {paginated.map((row) => (
              <tr key={row.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                ...
                <td style={{ padding: "10px 12px", color: "#0d2238", fontWeight: 700 }}>{row.averageRating != null ? (
            ...
            {paginated.length === 0 && (
              <tr>
                <td colSpan={8} style={{ padding: 24, textAlign: "center", color: "#94a3b8" }}>Không có phòng nào.</td>
              </tr>
            )}
          </tbody>
        </table>
