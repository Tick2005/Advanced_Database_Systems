...
export default function Home() {
  ...
  const topRooms = useMemo(() => {
    ...
    return sortRoomsByProximityAndRating(rooms, branches, userLocation)
      .slice(0, 4)
      .map((room, index) => ({
        ...room,
        img: room.imageUrl || ROOM_IMAGES[index % ROOM_IMAGES.length]
      }));
  }, [rooms, branches, userLocation]);
  ...
  console.log("Services:", servicesQ.data);
  console.log("Feedback:", feedbackQ.data);
  /* ── Branch init ── */
  useEffect(() => {
